        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="mt-8 p-4 rounded bg-bg-dark/80 border border-border-dark">
              ...
              <div className="space-y-2 text-xs font-mono">
                <div className="flex justify-between text-text-light">
                  ...
                  <span className="text-accent tabular-nums">10:00 — 21:00</span>
                </div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row sm:items-center gap-4">
              <a
                href="tel:0951079215"
                className="inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-accent text-bg-dark font-display text-xl font-bold uppercase tracking-wider rounded hover:bg-accent-deep transition-colors duration-200 ease-out whitespace-nowrap shadow-sm"
              >
              ...
              <a
                href="#branches"
                className="text-xs uppercase tracking-wider text-text-light hover:text-accent font-semibold border-b border-border-dark pb-1 transition-colors duration-200 ease-out"
              >
                Переглянути мапу філій →
              </a>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-bg-surface border border-border-dark rounded text-text-light placeholder:text-text-muted/60 focus:border-accent text-sm"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-bg-surface border border-border-dark rounded text-text-light placeholder:text-text-muted/60 focus:border-accent text-sm font-mono"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-bg-surface border border-border-dark rounded text-text-light focus:border-accent text-sm"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-bg-surface border border-border-dark rounded text-text-light focus:border-accent text-sm font-mono"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-accent text-bg-dark font-display text-2xl font-bold uppercase tracking-wider rounded hover:bg-accent-deep transition-colors duration-200 ease-out mt-2"
                >
